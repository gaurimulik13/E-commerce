...
const Slide=({img,title, maniTitle,price}) => {
  return (
    ...
    <div className='absolute left-[30px] md:left[70px] max-w-[250px] sm:max-w-[350px] top-[50%] -translate-y-[50%] space-y-2 lg:space-y-4 bg-[#ffffffa2] sm:bg-transparent p-4 sm:p-0 rounded-lg sm:rounded-none'>
     ...
     <bold><h2 className='text-blackish text-[26px] md:text-[30px] lg:text-[44px] font-bold leading-[1.2] '>{maniTitle}</h2></bold>
        <h3 className='text-[24px] text-gray-500'>
            starting at {""}
             <strong className='text-[20px] md:text-[24px] lg:text-[30px]'>{price}</strong>.00
        </h3>
        <div className='bg-accent text-white text-[14px] md:text-[16px] p-2 px-4 rounded-lg inline-top hover:bg-blackish'>Shop Now</div>
    </div>
